...
import { CheckCircle, Clock, PlayCircle, AlertCircle, Users, TrendingUp, ChevronDown, ChevronUp, Eye, Calendar, User, FileText } from 'lucide-react'
import type { ProjectGroup } from '@/utils/csv-data-fetcher'
...
export function ProjectGroupCard({ group }: ProjectGroupCardProps) {
  ...
  const getProjectDescription = (project: any) => {
    ...
    } else if (projectName.includes('clasificador') && projectName.includes('documento')) {
  ...
  // Resto del código del componente con las tarjetas individuales expandibles...
